...
{footerLinks.map((footerLink) =>(
  <div key={footerLink.key} className='flex flex-col ss:my-0 my-4 min-w-[150px]'>
    ...
    <ul>
      ...
      <p className="font-raleway font-normal text-dimWhite text-[14px] leading-[24.8px] mt-4 w-[80%]"><span className="font-raleway font-bold text-purple-950 hover:text-orange-600 text-[18px] leading-[32.8px]">Disclaimer! <br /></span>All graffiti & streetart spots in this legal wall directory are contributed by users. 
