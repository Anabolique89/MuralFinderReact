...
const BottomNavigation = () => {
    const Menus = [
        ...
        {name: "Message", icon:"add-circle-outline", dis: "translate-x-32"},
        {name: "Photos", icon:"location-outline", dis: "translate-x-48"},
      ...
      return (
        <div className="cta-block max-h-[4.4rem] px-6 rounded-t-xl">
          <ul className="flex relative">
            <span
              className={`cta-block duration-500 ${Menus[active].dis} border-4 border-white h-16 w-16 absolute
             -top-5 rounded-full`}
            >
              <span
