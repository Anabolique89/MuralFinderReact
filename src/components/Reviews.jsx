    ...
    return (
        <section className=''>
            ...
            <article className="md:gap-8 md:grid md:grid-cols-3">
                <div className='card bg-white p-5 rounded m-2'>
                    <div className="flex items-center mb-6">
                        <img className="w-12 h-12 me-4 rounded-full" src={defaultimg} alt="" />
                        <div>
                    ...
                    <div className="flex items-center mb-1 mt-3 space-x-1 rtl:space-x-reverse">
