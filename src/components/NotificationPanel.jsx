              ...
              <div className="w-full bg-white rounded-lg shadow-lg ring-1 ring-gray-900/5">
                <div className="p-4">
                  {notifications.map(notification => (
                    <div
                      key={notification.id}
                      className={`group relative flex gap-x-4 rounded-lg p-4 transition duration-200 ${!notification.read_at ? 'bg-gray-100 hover:bg-gray-200' : 'bg-white'}`}
                ...
                <div className="flex justify-center p-2 border-t border-gray-200">
                  {loading ? (
                    ...
                    <button onClick={() => setNotifications(prev => [...prev])} className="text-indigo-600 hover:underline">
                      Load More
                    </button>
                  )}
                </div>
