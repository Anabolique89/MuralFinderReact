...
const Profile = () => {
  return (
//     <section className=' flex flex-column profile bg-indigo-700 w-full overflow-hidden'>
//       <div className={`${styles.paddingX} profile-bg`}>
// <div className={`${styles.paddingX} flex justify-left items-start wrapper`}>
//   <div className='profile-info'>
//     <div className='profile-info-img'>
// <img className='profile-info-img' src={defaultimg} alt="profile" />
//     </div>
...
// <h3>FOLLOWERS <span className='followers'>20</span></h3>
// <h3>FOLLOWING <span className='following'>7</span></h3>
// <hr className='separator' />
// <div className='break' ></div>
// <a href="ProfileSettings/" className={`py-2 px-4 bg-blue-gradient font-raleway font-bold text-[16px] text-primary outline-none uppercase rounded-full ${styles}`}>SETTINGS</a>
//     </div>
//   </div>
...
//     <h3 className='flex-1 font-raleway font-bold ss:text-[28px] text-[20px] text-white ss:leading-[52px] leading-[32px]'>Profile title goes here</h3>
//     <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Profile text goes here</p>
// <div className='highlights flex flex-column'>
// <img src={defaultimg} alt="" className='highlight' />
// <img src={defaultimg}alt="" className='highlight' />
// <img src={defaultimg} alt="" className='highlight' />
// <img src={defaultimg} alt="" className='highlight' />
// <img src={defaultimg} alt="" className='highlight' />
// </div>
//   </div>
// <div className= {`${styles.paddingY} flex justify-right items-end profile-posts`}>
// <h3 className='posts'>BLOG POSTS</h3>
// <div className='profile-post'>
// <h2>IT IS A BUSY DAY IN TOWN</h2>
// <p>Lorem Ipsum Text like Threads</p>
// <p>date goes here </p>
// </div>
            ...
            <div className="col-span-4 sm:col-span-3">
                <div className="bg-white profile-content p-6 ">
                    <div className="flex flex-col items-center">
                        ...
                        <h1 className="text-xl username-name">Username</h1>
